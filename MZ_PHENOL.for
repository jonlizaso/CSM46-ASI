...
!  08/09/2013 JIL Added ASI for CERES Maize
!----------------------------------------------------------------------
      SUBROUTINE MZ_PHENOL(DYNAMIC,ISWWAT,FILEIO,IDETO,           !C
     &    AAGDD,CUMDEP,DAYL,DLAYR,LEAFNO,LL,NLAYR,PLTPOP,SDEPTH,  !I
     &    SI1,SI3,SNOW, SRAD,SUMP,SW,TMAX,TMIN, TWILEN,           !I
     &    XN,YRDOY,YRSIM,                                         !I
     &    CUMDTT,DTT,EARS,GPP,IDURP,ISDATE,ISTAGE,MDATE,          !O
     &    STGDOY,SUMDTT,XNTI,TLNO,XSTAGE,YREMRG,RUE,KCAN,KEP,     !O
     &    DSGFT,GFSWTCH,P3,THRE,TSEN,CDAY,SeedFrac,VegFrac)       !O
...
!      REAL            ABSTRES         
      REAL            AAGDD
      REAL            ACOEF           
      REAL            ASI         ! Anthesis-Silking Interval (ASI), days
...
!     -----------------------------------------------------------------
     ...
     %                   P1,P2,P5,G2,G3,PHINT,ASI,ASIS; LNUM = LNUM+1 
...
!          YREMRG = -99  !CHP 5/19/2011
                         !JIL 3/07/2015 Allow using emergence date when available
...
!              VegFrac = 1.0
      ...
      !-----------------------------------------------------------------
      !       ISTAGE = 3 - Tassel Initiation to Flowering
      !-----------------------------------------------------------------
...
!     CHP 5/25/2007 Move inflection point back to end of stage 3
      ...
      !-----------------------------------------------------------------
      !       ISTAGE = 4 - Flowering to Beginning Effective Gra
      !-----------------------------------------------------------------
...
!     CHP 5/25/2007 Move inflection point back to end of stage 3
              ...
              IF(SUMDTT.LT.DSGFT .OR. SUMDTT.LT.AAGDD .OR. 
     &           GFSWTCH .EQ. 0) RETURN
...
!             SeedFrac = (SUMDTT - DSGFT) / (P5 - DSGFT)
      ...
      !-----------------------------------------------------------------
      !       ISTAGE = 6 - End Effective Grain Filling to Physiol Matur
      !-----------------------------------------------------------------
